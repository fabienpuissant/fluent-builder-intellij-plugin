...
public class CreateCommand implements BuilderCommand {
  ...
  private static final class CreateCommandBuilder
    implements CommandContentBuilder, CommandSignatureBuilder, CommandScopeBuilder, CreateCommandTypeBuilder {
  ...
  public String toString() {
    return "CreateCommand{" + "signature=" + signature + ", content=" + content + ", scope=" + scope + '}';
  }
}
